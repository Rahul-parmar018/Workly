...
export default function Dashboard() {
  ...
  const [counts, setCounts] = useState({ users: 0, providers: 0, bookings: 0 });
    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-1000">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <MiniAreaChartCard
          ...
          amount={loading ? "..." : counts.providers.toLocaleString()}
          change="+5.4%"
          isPositive={true}
          data={salesData}
          color="#10b981"
        ...
        <MiniAreaChartCard
          ...
          amount={loading ? "..." : counts.bookings.toLocaleString()}
          change="+18.2%"
          isPositive={true}
